...
public class ChampionsCup extends AppCompatActivity implements View.OnClickListener {
    private Button launch_btn;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_champions_cup);
    }
    String lokalizacja1 = "google.navigation:q=147+Break+Zamieniecka,+Zamieniecka+80,+04-158+Warszawa&mode=d";
